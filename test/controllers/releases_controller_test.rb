...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { icon: @release.icon, is_public: @release.is_public, name: @release.name, project_id: @release.project_id, tag: @release.tag } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { icon: @release.icon, is_public: @release.is_public, name: @release.name, project_id: @release.project_id, tag: @release.tag } }
