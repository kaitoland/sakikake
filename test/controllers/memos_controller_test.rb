...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { is_team: @memo.is_team, team_id: @memo.team_id, user_id: @memo.user_id } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { is_team: @memo.is_team, team_id: @memo.team_id, user_id: @memo.user_id } }
